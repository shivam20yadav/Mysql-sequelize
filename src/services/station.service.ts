...
export class station_service{
  ...
  static addstation (newstation : station_data) {
    return new Promise(async (resolve, reject) => {
      try {
  ...
  static updatestation (station_name:string, updated_station:Request | any) {
  ...
  static deletestation (station_name:string) {
    return new Promise(async (resolve, reject) => {
      try {
