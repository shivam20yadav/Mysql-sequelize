...
const train_Station_route = require('./') // routes for a adding which train go which station are defined in train_station.route.ts
...
route.use('/train/station', train_Station_route); // use station routes');
