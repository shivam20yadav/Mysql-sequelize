...
const booking_controller = __importStar(require("../controller/booking.controller")); // booking controller is defined in booking.controller.ts
const booking_route = express_1.default.Router(); // create express router
